...
| Файл | Что это |
|---|---|
| `Islet-win-Setup.exe` | Установщик: ярлык в меню «Пуск», запись в «Приложениях» и автообновление. |
| `Islet-win-Portable.zip` | Распаковать куда угодно и запустить `Islet.exe`. Обновляется руками. |
