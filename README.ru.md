...
| `bat ` | заряд мышей, клавиатур, гарнитур и геймпадов |
...
- **Заряд устройств.** Мыши, клавиатуры, гарнитуры и геймпады: Logitech (HID++, через приёмник
  и напрямую), Bluetooth-устройства, чей заряд знает Windows, и устройства из общей базы
  рецептов — SteelSeries, Corsair, HyperX, Ajazz, Aula и другие. Садится — пик, почти сел —
  напоминание в капсуле; `bat ` — все устройства с зарядом. Своё устройство можно добавить без
  программирования: [docs/devices.ru.md](docs/devices.ru.md).
